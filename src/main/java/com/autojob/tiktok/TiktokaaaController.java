...
public class TiktokaaaController extends BaseWebViewTask {
    ...
    public static TiktokaaaController newInstance(String profileName) {
        ...
        return new TiktokaaaController(webDriver);
    }

    private TiktokaaaController(WebDriver webDrive) {
        super(null, null);
        onSearchKey();
    }
